...
import com.thinkgem.jeesite.tdk3A.systemmanagement.service.SystemManagementService;
...
public class SystemManagementController extends BaseController {
	 ...
	 * @return
	 */
	@RequiresPermissions("systemmanagement:accountmanagement:view")
	@RequestMapping(value = {"accountManagement"})
	public String accountManagement(SystemManagementEntity systemManagement, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "jeesite/tdk3A/systemmanagement/accountManagement";
	}
	/**
	 * 添加或修改账号
	 * @param systemManagement
	...
	public String addAccount(SystemManagementEntity systemManagement, HttpServletRequest request, HttpServletResponse response, Model model) {
		/*Page<SystemManagement> page = systemManagementService.findPage(new Page<SystemManagement>(request, response), systemManagement); 
		model.addAttribute("page", page);*/
		return "jeesite/tdk3A/systemmanagement/accountAddForm";
	}
	...
	public String dataManagement(SystemManagementEntity systemManagement, HttpServletRequest request, HttpServletResponse response, Model model) {
		/*Page<SystemManagement> page = systemManagementService.findPage(new Page<SystemManagement>(request, response), systemManagement); 
		model.addAttribute("page", page);*/
		return "jeesite/tdk3A/systemmanagement/dataManagement";
	}
	...
	/*@RequiresPermissions("systemmanagement:systemManagement:view")
	@RequestMapping(value = "form")
	public String form(SystemManagement systemManagement, Model model) {
		model.addAttribute("systemManagement", systemManagement);
		return "tdk3a/systemmanagement/systemManagementForm";
	}

	@RequiresPermissions("systemmanagement:systemManagement:edit")
	@RequestMapping(value = "save")
	public String save(SystemManagement systemManagement, Model model, RedirectAttributes redirectAttributes) {
		if (!beanValidator(model, systemManagement)){
			return form(systemManagement, model);
		}
		systemManagementService.save(systemManagement);
		addMessage(redirectAttributes, "保存系统管理成功");
		return "redirect:"+Global.getAdminPath()+"/systemmanagement/systemManagement/?repage";
	}
	
	@RequiresPermissions("systemmanagement:systemManagement:edit")
	@RequestMapping(value = "delete")
	public String delete(SystemManagement systemManagement, RedirectAttributes redirectAttributes) {
		systemManagementService.delete(systemManagement);
		addMessage(redirectAttributes, "删除系统管理成功");
		return "redirect:"+Global.getAdminPath()+"/systemmanagement/systemManagement/?repage";
	}*/
