...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public void saveRole(Role role) {
		...
		// 删除后新增j角色门禁对应信息
		deleteRoleDoor(role);
		for(int i = 0;i<role.getColumnList().size();i++){
			role.setfControllerid(role.getColumnList().get(i).getfControllerid());
			insertRoleDoor(role);
		}
		
		// 删除后新增部门角色对应信息
		deleteRoleOffice(role);
		for(int i = 0;i<role.getOfficeColumnList().size();i++){
			role.setOfficeId(role.getOfficeColumnList().get(i).getId());
			insertRoleOffice(role);
		}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	 ...
	 * @return
	 */
	public List<AccessControlEntity> getAllDoorAreadySelect(Role role){
		List<AccessControlEntity> list = roleDao.getAllDoorAreadySelect(role);
		return list;
	}
	 ...
	 * @return
	 */
	public List<AccessControlEntity> getAllDoorByArea(Role role){
		List<AccessControlEntity> list = roleDao.getAllDoorByArea(role);
		return list;
	}
	 ...
	 * @param role
	 */
	public void insertRoleDoor(Role role){
		roleDao.insertRoleDoor(role);
	}
	 ...
	 * @param role
	 */
	public void deleteRoleDoor(Role role){
		roleDao.deleteRoleDoor(role);
	}
	 ...
	 * @return
	 */
	public List<Office> getAllOfficeAreadySelect(Role role){
		List<Office> list = roleDao.getAllOfficeAreadySelect(role);
		return list;
	}
	 ...
	 * @return
	 */
	public List<Office> getAllOffice(Role role){
		List<Office> list = roleDao.getAllOffice(role);
		return list;
	}
	...
	public void insertRoleOffice(Role role){
		roleDao.insertRoleOffice2(role);
	}
	...
	public void deleteRoleOffice(Role role){
		roleDao.deleteRoleOffice2(role);
	}
