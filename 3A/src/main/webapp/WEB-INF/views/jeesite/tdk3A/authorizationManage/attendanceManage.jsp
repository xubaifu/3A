...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a
			href="${ctx}/authorizationManage/authorizationManage/attendance">考勤机授权</a></li>
	</ul>
	<div>
	...
	<div>
		...
		<div id="two_way_list_selector_b" class="two_way_list_selector margin_top_10">
			<div class="select_l">
				...
				<div class="select_a">
					<c:forEach items="${list}" var="attendance" varStatus="st">
						<div data-value="${attendance.bh}" data-index="0" class="item">${attendance.mc}</div>
					</c:forEach>
	...
	<div style="margin-left: 44%">
		...
		<a href="${ctx}/authorizationManage/authorizationManage/attendance"><input id="btnSubmit" class="btn btn-primary" type="button" value="重置"/></a>
		&nbsp;&nbsp;&nbsp;&nbsp;
